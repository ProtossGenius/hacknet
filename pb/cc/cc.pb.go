...
// HackIn send a makesure message.
type HackIn struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Hello string `protobuf:"bytes,1,opt,name=hello,proto3" json:"hello,omitempty"` // TODO: maybe some check message.
}
...
func (x *HackIn) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HackIn) ProtoMessage() {}

func (x *HackIn) ProtoReflect() protoreflect.Message {
	mi := &file_cc_proto_msgTypes[0]
...
// Deprecated: Use HackIn.ProtoReflect.Descriptor instead.
func (*HackIn) Descriptor() ([]byte, []int) {
	return file_cc_proto_rawDescGZIP(), []int{0}
}

func (x *HackIn) GetHello() string {
	if x != nil {
		return x.Hello
	}
	return ""
...
var file_cc_proto_rawDesc = []byte{
	0x0a, 0x08, 0x63, 0x63, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02, 0x63, 0x63, 0x22, 0x1e,
	0x0a, 0x06, 0x48, 0x61, 0x63, 0x6b, 0x49, 0x6e, 0x12, 0x14, 0x0a, 0x05, 0x68, 0x65, 0x6c, 0x6c,
	0x6f, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x42, 0x49,
	0x0a, 0x17, 0x63, 0x6f, 0x6d, 0x2e, 0x73, 0x75, 0x72, 0x65, 0x6d, 0x6f, 0x6f, 0x6e, 0x2e, 0x68,
	0x61, 0x63, 0x6b, 0x6e, 0x65, 0x74, 0x2e, 0x70, 0x62, 0x42, 0x03, 0x43, 0x32, 0x43, 0x5a, 0x29,
	...
	0x2f, 0x70, 0x62, 0x2f, 0x63, 0x63, 0x3b, 0x63, 0x63, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_cc_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_cc_proto_goTypes = []interface{}{
	(*HackIn)(nil), // 0: cc.HackIn
}
